...
const getMaxFiledValue = (countries, { normalizeByFieldIndex }) =>
    countries.reduce((acc, country) => Math.max(acc, country[normalizeByFieldIndex]), 0);
...
const processData = data => {
    ...
    const normalizeToValue = getMaxFiledValue(countriesInfo, { normalizeByFieldIndex });
