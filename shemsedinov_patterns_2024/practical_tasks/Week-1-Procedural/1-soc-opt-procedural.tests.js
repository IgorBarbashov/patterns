...
test('Week 1: parseCountriesInfo parse data correctly', () => {
    ...
    const actual = parseCountriesInfo(
        testData,
        { rowDelimiter, fieldDelimiter, parseToIntFieldIndexes },
    );
    const expectedLength = 3;
    const expectedFirstElement = [
        'Shanghai', '24256800', '6340', 3826, 'China',
    ];
    const expectedThirdElement = [
        'Lagos', '16060303', '1171', 13712, 'Nigeria',
    ];
...
test(
    'Week 1: getMaxFieldValue calculate max value of specified field correctly',
    () => {
        const testData = [
            ['Shanghai', '24256800', '6340', 3826, 'China'],
            ['Delhi', '16787941', '1484', 11313, 'India'],
...
test(
    'Week 1: getCountriesWithNormalizedValues add column with normalized value',
    () => {
        const testData = [
            ['Shanghai', '24256800', '6340', 3826, 'China'],
            ['Lagos', '16060303', '1171', 13712, 'Nigeria'],
        ...
        const actual = getCountriesWithNormalizedValues(
            testData,
